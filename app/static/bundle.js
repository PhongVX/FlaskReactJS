...
var _Note = __webpack_require__(39);

var _Note2 = _interopRequireDefault(_Note);

var _NoteForm = __webpack_require__(65);
        ...
        value: function render() {
            if (this.props.isAdding) {
                return _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement('input', { className: 'form-control', placeholder: 'Node name', ref: 'txt', type: 'text' }),
                    _react2.default.createElement('br', null),
                    _react2.default.createElement(
                        'button',
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn btn-danger', onClick: this.toggle.bind(this) },
                        'H\u1EE7y'
                    ),
                    _react2.default.createElement('br', null)
                );
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn btn-primary', onClick: this.toggle.bind(this) },
                        'Add'
                    ),
                    _react2.default.createElement('br', null)
                );
...
var _mangreducer = __webpack_require__(67);

var _mangreducer2 = _interopRequireDefault(_mangreducer);

var _isaddingreducer = __webpack_require__(69);
...
var reducer = redux.combineReducers({ mang: _mangreducer2.default, isAdding: _isaddingreducer2.default });
...
var _mang = __webpack_require__(68);

var _mang2 = _interopRequireDefault(_mang);
...
var mangReducer = function mangReducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _mang2.default;
...
var _isadding = __webpack_require__(70);

var _isadding2 = _interopRequireDefault(_isadding);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var reducerIsAdding = function reducerIsAdding() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _isadding2.default;
    var action = arguments[1];
